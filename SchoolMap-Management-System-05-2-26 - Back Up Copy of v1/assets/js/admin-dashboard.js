...
(async () => {
  ...
  async function fetchRoutes() {
    ...
    const routes = res?.data?.routes || res?.routes || [];
  ...
  async function fetchFloors() {
    ...
    const floors = res?.data?.floors || res?.floors || [];
  ...
  async function fetchLegends() {
    ...
    const legends = res?.data?.legends || res?.legends || [];
  ...
  async function fetchLocations() {
    ...
    const pins = res?.data?.pins || res?.pins || [];
